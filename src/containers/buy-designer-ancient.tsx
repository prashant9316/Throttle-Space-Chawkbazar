...
const BuyDesignerAncient: React.FC<Props> = ({ imgWidth, imgHeight }) => {
  ...
  return (
    ...
    <div className="pt-6 pb-5 md:pt-12 md:pb-7 bg-black mb-7 md:mb-10 lg:mb-12 xl:mb-14 2xl:mb-[75px]">
      <Container>
        <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row md:items-center xl:items-center 2xl:flex-row 2xl:justify-between 2xl:items-center 2xl:gap-x-3">
          <div className="2xl:w-[650px] mb-8 sm:mb-10 md:mb-12">
            ...
            <div className="mb-6 text-base leading-8 text-white md:mb-8 lg:mb-10 xl:mb-10 md:text-base lg:text-base xl:text-base 2xl:text-lg 3xl:text-lg ltr:pr-4 rtl:pl-4 md:leading-8 lg:leading-8 xl:leading-8 2xl:leading-8 3xl:leading-8">
          ...
          <div className="grid grid-cols-2 gap-2 2xl-w-auto sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 sm:gap-2 md:gap-2">
            {error ? (
